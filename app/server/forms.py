...
class ServiceForm(FlaskForm):
    ...
    ip_local = StringField('IP local', id='ip-local')
    port_local = StringField('Puerto local', id='port-local')
    ip_public = StringField('IP pública', id='ip-public')
    port_public = StringField('Puerto público', id='port-public')
