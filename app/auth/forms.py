...
class UserForm(FlaskForm):
    ...
    email = StringField('Email', validators=[DataRequired()])
    change_password = BooleanField('Cambiar contraseña', id='change_password')
    password = PasswordField('Contraseña', id='password', validators=[DataRequired()])
    show_password = BooleanField('Mostrar contraseña', id='show_password')
