...
class ServerForm(FlaskForm):
    ...
    server_environment_id = QuerySelectField(
        "Entorno",
        query_factory=environment_service.get_all,
        get_label="name"
    )
    server_operating_system_id = QuerySelectField(
        "Sistema operativo",
        query_factory=operating_system_service.get_all
    )
